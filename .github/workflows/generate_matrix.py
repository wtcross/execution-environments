...
def main():
    """Main function to generate a matrix based on changed directories containing 'execution-environment.yaml'."""
    ...
    for file in changed_files:
        ...
        ee_file_path = os.path.join(os.getenv('GITHUB_WORKSPACE', ''), dir_name, "execution-environment.yaml")
